...
본 웹사이트는 서버 백엔드 없이 작동하는 고품격 정적 웹 애플리케이션(SPA)입니다. GitHub Pages를 활용하여 무료로 호스팅할 수 있으며, 소유하고 계신 커스텀 도메인 `myjohorn.com`을 즉시 연결하여 상용 웹사이트로 사용할 수 있도록 준비되어 있습니다.
...
6. **Custom domain** 입력 칸에 `myjohorn.com`을 입력하고 **Save**를 누릅니다.
...
`www.myjohorn.com`으로 접속해도 내 사이트로 연결되도록 CNAME 레코드를 설정합니다.
